...
?>
	...
	<div id="addVenue">
		<fieldset>
			...
			<input type="text" name="vURL" maxlength="100" value="http://" size="50" />
	...
	<p>Cover Charge?</p>
	<input type="text" value="none" name="cover" size="10" />
	...
	$ <input type="text" value="0" name="revenue" size="10" />
	<p>Miscellaneous Show Information:</p>
	<textarea name="info" rows="5" cols="60"></textarea>
	<p class="submit"><input type="submit" name="submit" value="Add Show" /></p>
	<p>&nbsp;</p>
...
?>
	...
	<p>Miscellaneous Show Information:</p>
	<textarea name="info" rows="5" cols="60"><?php echo $_POST["info"]; ?></textarea>
	<p class="submit"><input type="submit" name="submit" value="Add Show" /></p>
	<p>&nbsp;</p>
	<p><font size="1">* Denotes required field(s)</font></p>
</form>
		...
		********************************************************/
		...
		{ // START ELSE no errors found
			...
			***********************************************************************************/
			...
			$strSQL = "INSERT INTO shows (show_date, show_date_display, show_venue_ID, show_cover, show_time_start, show_time_end, show_info, show_revenue) ";
			$strSQL .= "VALUES (\"$dtmDate\", \"$strDisplayDate\", \"$strVenue\", \"$strCover\", \"$strStart\", \"$strEnd\", \"$strInfo\", \"$strRevenue\");";
			$qrySQL = mysql_query($strSQL) or die (mysql_error()); //run the insert query

?>

<p><font color="green">The following show was successfully entered!</font></p>
...
?>
	...
	<p><a href="index.php?page=addshow">Add Another Show?</a></p>
<?php
