...
<form name="edit" method="post" action="index.php?page=editshow">
	<input type="hidden" name="enter" value="true" />
	<p>Select the show you would like to edit...</p>
	<p>&nbsp;</p>
<?php
...
?>
	...
	<p class="submit"><input type="submit" name="update" value="Update this Show" /></p>
	<p>&nbsp;</p>
		...
		********************************************************/
		...
		{ // START ELSE no errors found
			...
			***********************************************************************************/
			...
			$strSQL = "update shows set
													show_date =\"$dtmDate\",
													show_date_display =\"$strDisplayDate\",
													show_venue_ID =\"$strVenue\",
													show_cover =\"$strCover\",
													show_time_start =\"$strStart\",
													show_time_end =\"$strEnd\",
													show_info =\"$strInfo\",
													show_revenue =\"$strRevenue\"
													where show_ID = $id;";
			$qrySQL = mysql_query($strSQL) or die (mysql_error()); //run the insert query

?>

<p><font color="green">The following show was successfully updated!</font></p>
<p>&nbsp;</p>
