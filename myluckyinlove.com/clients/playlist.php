...
?>
			...
			<h2 style="text-align: left !important;margin-bottom:0px !important;">Playlist</h2>
			<p>Add a song to your playlist*, or remove one you've already entered. If you do not know the name of the artist, enter &quot;unknown&quot; in the field.</p>
			<p class="note_this">*Though we will do our best to play all songs listed, adding songs to your playlist does NOT guarantee that they will be played the day of your event</p>
			...
			<div style="float: left;">
				<form name="addSong" method="get" action="javascript:verifyData();">
					...
					<p style="text-align:right;"><input id="submit" type="submit" value="Add Song >>>" /></p>
				</form>
			</div>
			...
			<script language="javascript">
				...
				{					
					...
					{
						updatePlaylist(document.addSong.song_title.value, document.addSong.artist.value, <? echo $intClientID; ?>);
					}
				}
				...
				function addSong(intID)
				{
					...
					var strNewSong = "<p class=\"" + strClass + "\" style=\"padding-bottom: 2px;\"><a href=\"#\" class=\"btn_cancel\" onclick=\"deletePlaylist(" + intID + ");this.parentNode.style.display = 'none';return false;\"></a>&nbsp;&nbsp;&nbsp;" + strSongTitle + " by " + strArtist + "</p>";
...
?>
				<p<? if ($blnOdd) { echo " class=\"odd\""; } ?> style="padding-bottom: 2px;display: block;">
					<a href="#" class="btn_cancel" onclick="deletePlaylist(<? echo $intID ?>);this.parentNode.style.display = 'none';return false;"></a>&nbsp;&nbsp;&nbsp;<? echo $strSongTitle ?> by <? echo $strArtist ?>
				</p>
<?
	$i = $i + 1;
}
